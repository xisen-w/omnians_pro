...
class LLMAgent(Agent):
    ...
    def perform_action(self, user_prompt: str, system_prompt: str, schema_class: BaseModel):
        """
    ...
    def to_string(self):
        ...
        if self.previous_result:
            # Assuming the result is a Pydantic model, we convert it to JSON and then to a string
